...
- 2026-02-21 | PR: pending | Phase: 3 UX Hardening | Fixed active workout add-exercise UX to support multi-select in exercise picker, batch-apply selected exercises on return, prevent duplicate param re-processing with selection tokens, and keep workout state stable while adding multiple exercises.
